package com.sivalabs.moviebuffs.tools.testing;
...
public class SeleniumTests {
    ...
    public static void main(String[] args) {
        System.setProperty("webdriver.chrome.driver", System.getProperty("user.home")+"/mybin/chromedriver");
    ...
    private static void gotoCartAndPlaceOrder() {
        ...
        WebElement orderButton = driver.findElement(By.xpath("//button[contains(text(),'Place Order')]"));
        orderButton.click();
    }
    ...
    private static void addItemsToCart(int n) {
        List<WebElement> elements = driver.findElements(By.xpath("//button[contains(text(),'Add to Cart')]"));
