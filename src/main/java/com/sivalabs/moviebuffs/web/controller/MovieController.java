...
public class MovieController {
    ...
    public String home(
        ...
        if(StringUtils.isEmpty(query)) {
            ...
            data = movieService.getMovies(pageable);
    ...
    public String viewBook(@PathVariable Long id, Model model) {
        MovieDTO movie = movieService.getMovieById(id).orElse(null);
    ...
    public String byGenre(@PathVariable String slug,
        ...
        if(byId.isPresent()) {
            Page<MovieDTO> data = movieService.findMoviesByGenre(byId.get().getId(), pageable);
